...
export default function QuestionView() {
  ...
  const { id, timelineItemId, questionId } = useLocalSearchParams();
  ...
  const handleBack = () => (router.canGoBack() ? router.back() : router.push(`/job-position/${id}/timeline/${timelineItemId}`));
