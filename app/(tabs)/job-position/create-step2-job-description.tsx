...
export default function CreateStep2Description() {
  ...
  const defaultValues = { profileId: "" as string | null, jobDescription: "" };
        ...
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"}>
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              <CenteredTextHeading title="Enter Job Description" subtitle="Paste the complete job description below" />
