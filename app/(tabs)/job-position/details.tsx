    ...
    const fetchJobPosition = async () => {
      try {
        ...
        const mockJobPosition: JobPosition = {
          ...
          jobDescription: 'We are looking for a passionate Senior Frontend Developer to join our growing team. You will be responsible for building user-facing features using React, TypeScript, and modern web technologies.',
